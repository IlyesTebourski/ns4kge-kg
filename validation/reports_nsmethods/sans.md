...
|---|---|:---:|---|
| Adversarial Negative Sampling | prose+table | name | al., 2018; Sun et al., 2019). However, adversarial negative sampling methods are computationally expensive, |
...
| Methode | Ou | Via | Extrait |
|---|---|:---:|---|
| Importance Sampling | prose | name | ation of the partition function used in Importance Sampling (IS) (Bengio et al., 2003). **Non-Fixed |
