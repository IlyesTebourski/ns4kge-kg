...
|---|:---:|---|---|
| Accuracy | ✅ oui | (hors table) | </tr> </tbody> </table> Table 1: Accuracy and Macro-F1 on arXiv-AstroPh and arXiv |
| F1 | ✅ oui | (hors table) | > </table> Table 1: Accuracy and Macro-F1 on arXiv-AstroPh and arXiv-GrQc in link |
