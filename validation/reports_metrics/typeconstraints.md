...
|---|:---:|---|---|
| AUPRC | ✅ oui | (hors table) | ody> </table> Table 2.** Comparison of AUPRC and AUROC result for RESCAL with and wi |
| AUROC | ✅ oui | (hors table) | le> Table 2.** Comparison of AUPRC and AUROC result for RESCAL with and without expl |
