...
|---|:---:|---|
| Link Prediction | ✅ oui | Knowledge Graph Completion with Relation-Aware Anchor Enhancement |

## Recall — Task du vocab (verifie) present mais NON extrait

| Item | Verdict | Extrait / justification |
|---|:---:|---|
| Relation Prediction | ✅ faux positif (ignore) | Taxonomie de related work citee. |
| Triple Classification | ✅ faux positif (ignore) | Meme phrase de taxonomie. |