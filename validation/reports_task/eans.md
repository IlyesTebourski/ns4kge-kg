...
|---|:---:|---|
| Link Prediction | ✅ oui | ict these missing link in KGs, a lot of link prediction (a.k.a., knowledge graph embedding) mod |

## Recall — Task du vocab (verifie) present mais NON extrait

| Item | Verdict | Extrait / justification |
|---|:---:|---|
| Entity Alignment | ✅ faux positif (ignore) | Limitation/travaux futurs. |