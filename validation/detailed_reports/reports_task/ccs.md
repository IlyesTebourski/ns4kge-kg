...
|---|:---:|---|
| Link Prediction | ✅ oui | e graph is often incomplete. Therefore, knowledge graph completion is particularly important as it predict |

## Recall — Task du vocab (verifie) present mais NON extrait

| Item | Verdict | Extrait / justification |
|---|:---:|---|
| Relation Prediction | ✅ faux positif (ignore) | Decoupage 1-to-1/1-to-N des resultats de LINK prediction. |