...
|---|:---:|---|---|
| FB15k | ✅ oui | (hors table) | PBG with other embedding methods on the FB15k dataset. PBG embeddings are trained wit |
| LiveJournal | ✅ oui | (hors table) | mance of PBG, DeepWalk, and MILE on the LiveJournal dataset and the YouTube dataset. **Left |
